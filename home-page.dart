...
import 'package:myapp/cenima-app-user/component.dart';
import 'package:myapp/cenima-app-user/rent-movie.dart';
import 'package:myapp/utils.dart';
import 'cinema-list.dart';
import 'food-menu-selection.dart';
import 'profile.dart';
import 'movie-screen-book.dart' as book;
import 'movie-screen-upcomming.dart' as upcomming;
import 'showing-now.dart' as showing;
import 'upcoming.dart' as upcom;
                          ...
                          child: Stack(
                            children: [
                              Positioned(
                                ...
                                child: TextButton(
                                  onPressed: () {
                                    navigateTo(context, upcomming.Scene());
                                  },
                                  style: TextButton.styleFrom(
                                    padding: EdgeInsets.zero,
                                  ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: TextButton(
                                      onPressed: () {
                                        navigateTo(context, showing.Scene());
                                      },
                                      style: TextButton.styleFrom(
                                        padding: EdgeInsets.zero,
                                      ),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          ...
                          textAlign: TextAlign.center,
                          style: SafeGoogleFont(
                              'Nature Beauty Personal Use', 25 * ffem,
                              fontWeight: FontWeight.w400,
                              height: 1.1 * ffem / fem,
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                'Book Ticket',
                                textAlign: TextAlign.center,
                                style: SafeGoogleFont('Segoe Script', 10 * ffem,
                                    fontWeight: FontWeight.w700,
                                    height: 1.2575 * ffem / fem,
