        ...
        child: Column(
          ...
          children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Container(
                        ...
                        padding: EdgeInsets.fromLTRB(104*fem, 0*fem, 104*fem, 24.5*fem),
                        width: double.infinity,
                        height: 92.5*fem,
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.center,
            ...
            Container(
              ...
              padding: EdgeInsets.fromLTRB(17.5*fem, 18.5*fem, 0*fem, 0*fem),
              width: double.infinity,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(112.5*fem, 0*fem, 132.99*fem, 26*fem),
                    child: TextButton(
                      onPressed: () {},
                      style: TextButton.styleFrom (
                        padding: EdgeInsets.zero,
                  ...
                  Container(
                    ...
                    child: TextButton(
                      ...
                      child: Container(
                        padding: EdgeInsets.fromLTRB(0*fem, 0*fem, 68.5*fem, 0*fem),
                        width: double.infinity,
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              height: 174*fem,
                              child: Image.asset(
                                'assets/cenima-app-user/images/-4gV.png',
                                fit: BoxFit.cover,
                              ),
                            ),
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 93.5*fem, 25*fem),
                                    width: double.infinity,
                                    child: Row(
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                      children: [
                                  ...
                                  Container(
                                    ...
                                    margin: EdgeInsets.fromLTRB(0.5*fem, 0*fem, 2*fem, 14*fem),
                                    width: double.infinity,
                                    height: 30*fem,
                                    child: Row(
                                      crossAxisAlignment: CrossAxisAlignment.center,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        padding: EdgeInsets.fromLTRB(0.5*fem, 17*fem, 0.5*fem, 0*fem),
                                        width: double.infinity,
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        padding: EdgeInsets.fromLTRB(0.5*fem, 27*fem, 0.5*fem, 0*fem),
                                        width: double.infinity,
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 56*fem, 45*fem),
                                              width: double.infinity,
                                              child: Row(
                                                crossAxisAlignment: CrossAxisAlignment.center,
                                                children: [
