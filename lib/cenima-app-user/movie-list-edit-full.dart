          ...
          children: [
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      height: 174 * fem,
                      child: Image.asset(
                        'assets/cenima-app-user/images/movie1u9.png',
                        fit: BoxFit.cover,
                      ),
                    ),
                    Container(
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: TextButton(
                            ...
                            child: Container(
                              padding: EdgeInsets.fromLTRB(
                                  29.23 * fem, 17 * fem, 18 * fem, 15 * fem),
                              width: 393 * fem,
                              height: 61 * fem,
                              decoration: BoxDecoration(
                                border: Border.all(color: Color(0xff707070)),
            ...
            Positioned(
              ...
              child: TextButton(
                ...
                child: Container(
                  padding:
                      EdgeInsets.fromLTRB(10 * fem, 9 * fem, 7 * fem, 6 * fem),
                  width: 51 * fem,
                  height: 49 * fem,
                  child: Center(
                    // loupeP89 (348:21460)
