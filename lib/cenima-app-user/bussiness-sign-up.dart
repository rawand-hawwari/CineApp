        ...
        child: Stack(
          children: [
            Positioned(
              ...
              top: 0*fem,
              child: Container(
                padding: EdgeInsets.fromLTRB(1*fem, 0*fem, 1*fem, 0.32*fem),
                width: 393*fem,
                height: 1103*fem,
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 977.44*fem),
                      width: double.infinity,
                      height: 54.56*fem,
                      decoration: BoxDecoration (
                        color: Color(0xffffffff),
                    ...
                    Container(
                      ...
                      child: TextButton(
                        ...
                        child: Container(
                          padding: EdgeInsets.fromLTRB(0*fem, 6.84*fem, 0*fem, 6.84*fem),
                          width: double.infinity,
                          height: 70.68*fem,
                          child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(0*fem, 1*fem, 136*fem, 0*fem),
                      child: Text(
                        'Password*',
                        style: SafeGoogleFont (
                          'Tw Cen MT',
            ...
            Positioned(
              ...
              top: 97*fem,
              child: Container(
                padding: EdgeInsets.fromLTRB(19*fem, 13*fem, 137*fem, 14*fem),
                width: 328*fem,
                height: 56*fem,
                decoration: BoxDecoration (
                  border: Border.all(color: Color(0xff020202)),
            ...
            Positioned(
              ...
              top: 564*fem,
              child: Container(
                padding: EdgeInsets.fromLTRB(19*fem, 13*fem, 167*fem, 14*fem),
                width: 328*fem,
                height: 56*fem,
                decoration: BoxDecoration (
                  border: Border.all(color: Color(0xff020202)),
            ...
            Positioned(
              ...
              top: 642*fem,
              child: Container(
                padding: EdgeInsets.fromLTRB(19*fem, 13*fem, 1*fem, 14*fem),
                width: 328*fem,
                height: 56*fem,
                decoration: BoxDecoration (
                  border: Border.all(color: Color(0xff020202)),
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(19*fem, 13*fem, 93*fem, 14*fem),
                      height: double.infinity,
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                    ...
                    Container(
                      ...
                      child: TextButton(
                        ...
                        child: Container(
                          padding: EdgeInsets.fromLTRB(10*fem, 18*fem, 2*fem, 19*fem),
                          width: double.infinity,
                          height: double.infinity,
                          child: Text(
                            'Set on map',
            ...
            Positioned(
              ...
              top: 720*fem,
              child: Container(
                padding: EdgeInsets.fromLTRB(19*fem, 13*fem, 208*fem, 14*fem),
                width: 328*fem,
                height: 56*fem,
                decoration: BoxDecoration (
                  border: Border.all(color: Color(0xff020202)),
            ...
            Positioned(
              ...
              top: 330*fem,
              child: Container(
                padding: EdgeInsets.fromLTRB(19*fem, 13*fem, 125*fem, 14*fem),
                width: 328*fem,
                height: 56*fem,
                decoration: BoxDecoration (
                  border: Border.all(color: Color(0xff020202)),
            ...
            Positioned(
              ...
              top: 798*fem,
              child: Container(
                padding: EdgeInsets.fromLTRB(19*fem, 13*fem, 83*fem, 14*fem),
                width: 328*fem,
                height: 56*fem,
                decoration: BoxDecoration (
                  border: Border.all(color: Color(0xff020202)),
            ...
            Positioned(
              ...
              top: 408*fem,
              child: Container(
                padding: EdgeInsets.fromLTRB(19*fem, 13*fem, 104*fem, 14*fem),
                width: 328*fem,
                height: 56*fem,
                decoration: BoxDecoration (
                  border: Border.all(color: Color(0xff020202)),
