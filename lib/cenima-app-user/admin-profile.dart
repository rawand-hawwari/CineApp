                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(
                                0 * fem, 4.41 * fem, 151.95 * fem, 0 * fem),
                            child: Text(
                              'First Name',
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(
                                0 * fem, 4.41 * fem, 153.95 * fem, 0 * fem),
                            child: Text(
                              'Last Name',
                              style: SafeGoogleFont(
                                'Tw Cen MT',
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(
                                0 * fem, 4.41 * fem, 199.95 * fem, 0 * fem),
                            child: Text(
                              'Email',
                              style: SafeGoogleFont(
                                'Tw Cen MT',
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            margin: EdgeInsets.fromLTRB(
                                0 * fem, 6.07 * fem, 14.33 * fem, 0 * fem),
                            width: 31.95 * fem,
                            height: 31.95 * fem,
                            child: Image.asset(
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(
                          0 * fem, 0 * fem, 102.68 * fem, 3.2 * fem),
                      child: Text(
                        '+ 123 000 000 000',
                        style: SafeGoogleFont(
                          'Tw Cen MT',
