        ...
        child: Stack(
          children: [
            Positioned(
              ...
              top: 106*fem,
              child: Container(
                padding: EdgeInsets.fromLTRB(9*fem, 39*fem, 9*fem, 79*fem),
                width: 393*fem,
                height: 1753*fem,
                decoration: BoxDecoration (
                  color: Color(0xfff1f1f1),
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(114*fem, 0*fem, 113*fem, 16*fem),
                      width: double.infinity,
                      height: 33*fem,
                      decoration: BoxDecoration (
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 22*fem, 62*fem),
                                  child: TextButton(
                                    onPressed: () {},
                                    style: TextButton.styleFrom (
                                      padding: EdgeInsets.zero,
