...
class _ChooseNoOfTciketsState extends State<ChooseNoOfTcikets> {
  ...
  Widget build(BuildContext context) {
    ...
    int limitPremuim=(screen.noOfSeatsPremuim-screen.bookedPremuim.length<10)?screen.noOfSeatsPremuim-screen.bookedPremuim.length:10;
                          ...
                          TextButton(
                            onPressed: () {
                              Navigator.pushReplacement(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        SeatSelection(standardTicket, primeTicket)),
                              );
